...
You can download it by visiting the Thonny website: https://thonny.org/. Once on the page, you will see a light gray box in the upper right corner, click on the link that applies to your operating system.
...
* C: The open folder icon lets you open a file that already exists on your computer. You can choose to open the code inside your computer or the Raspberry Pi Pico, if your Pico is already plugged into your computer.
...
* E: The play icon allows you to run the code. Remember that the code you write is meant to be executed. Running the code means you are telling Python, "Do what I tell you to do!" (In other words, "Read through my code and execute what I've written.")
...
* M：Python Shell, where you can type a single command, and when you press the key, the single command will run and provide information about the running program. This is also known as REPL, which means "Read, Evaluate, Print, and Loop."
* N：Interpreter, where the current version of Python used to run your program is displayed, can be changed manually to another version. the lower right corner of the Thonny window displays and allows you to change the current Python interpreter - the version of Python used to run your program. When your Pico is already plugged into your computer, you can switch your current interpreter (Python x.x.x) to MicroPython (Raspberry Pi Pico) in order to run your program on your Pico using MicroPython.
...
.. note::
   ...
   * The Raspberry Pi Pico interpreter is only available in version 3.3.3 and above (currently 3.3.3 is the latest version) of Thonny. If you are running an older version, please update to version 3.3.3 and above.
